...
$product = query("SELECT * FROM detail_product");
?>
...
<body>
    ...
    <main id="main" class="main">
      <div data-aos="fade-up" data-aos-offset="100" data-aos-duration="1000" class="container shadow-lg p-2 mb-2">
    ...
    <section id="product" class="product"> 
      <div class="row">
        ...
        foreach ($product as $prd) : ?>
          <div data-aos="fade-down" data-aos-offset="50" data-aos-delay="150" data-aos-duration="1000" class="col-md-3">
