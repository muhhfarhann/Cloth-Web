        ...
        <div class="container mb-5">
            <div class="table-responsive">
                    ...
                    <tbody class="align-middle">
                      <form action="" method="post">
                        <tr>
                          ...
                          <td class="text-center"><img src="img/mockup.jpg" alt="" title="" width="80"></td>
                          <td>Otto</td>
                          <td><input type="number" value="1" id="quantity" name="quantity" class="border" size="20"></td>
                          <td>$150.000</td>
                ...
                <div class="row text-end">
                    ...
                    <div class="col">
                        <!-- send to function -->
                        <a href="#function?=" type="submit" class="btn btn-outline-success btn-sm">UPDATE</a>
                    </div>
                    <div class="col">
                        <a href="#functionDelete?=" type="submit" class="btn btn-outline-success btn-sm">Delete</a>
                    </div>
                </div>
            </div>
        </div>
