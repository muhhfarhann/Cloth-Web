...
<html lang="en">
  ...
  <body class="index-page">
    ...
    <section class="hero mb-4">
      <main class="content">
        <h2 class="text-white">Raining Offers For hot summer!</h2>
        <div class="clear"></div>
    ...
    <h2>New Product</h2>
      <p data-aos="fade-right" data-aos-offset="300" data-aos-duration="1000" >Monthly New Product!</p>
      <div class="row justify-content-center">
        <?php 
        $count = 0;
        foreach ($product as $prd) : ?>
          <div data-aos="fade-down" data-aos-offsett="300" data-aos-delay="400" data-aos-duration="1500" class="col-md-3 border me-2 mb-1">
